...
public class UpdateHandlerService : IUpdateHandler
{
    ...
    private readonly UserRepositoryService _users;

    public UpdateHandlerService(ITelegramBotClient botClient, ILogger<UpdateHandlerService> logger, UserRepositoryService users)
    {
