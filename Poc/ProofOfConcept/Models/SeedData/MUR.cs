...
public static class MUR
{
    public static Route CreateRoute_MMUR()
    {
        ...
        var stage32 = CreateStage_MUR_32();
        ...
        var stages = new List<StageSequence>()
        {
            ...
            new() {AttachedRoute = route, From = stage31, To = stage32},
            new() {AttachedRoute = route, From = stage32, To = SeedData.ChooseStage},
        };
        route.Stages = stages;
        return route;
    }
    ...
    public static Stage CreateStage_MUR_1()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Text, Text = "На старой будке ты видишь Пикачу, со знакомства с ним мы и начнем наше путешествие. Но искать отправимся не покемонов, а уличное искусство. А оно часто анонимно.\n\nКстати, имя художника, нарисовавшего Пикачу, тоже неизвестно. Автор может оставить у рисунка свой тэг – это подпись граффити-художника. Правда, если ты мало интересуешься темой, этот тэг тебе мало поможет.\n\nНо сейчас многие граффитисты перестали скрывать лица и свои работы открыто публикуют в соцсетях. Поэтому в некоторых локациях на нашем маршруте ты сможешь узнать об авторах работ!",
            }}
        };
        var step11 = new Step()
        {
    ...
    public static Stage CreateStage_MUR_2()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Text, Text = "Надпись гласит:\n«Мы – буквы, с нами текст».\n\nЭто самая масштабная текстовая стрит-арт работа в Томске. Создал ее художник Владимир Абих для фестиваля «мУкА. Склады искусства».\n\nЭто арт-фестиваль в Томске, объединяющий современное искусство и культурное наследие.",
    ...
    public static Stage CreateStage_MUR_3()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIOx2NXCWjixeT4mCctYU5YXe3CSDSfAALFwzEbhDm4Skofz6nswBAgAQADAgADeQADKgQ"}, Caption ="Мы стоим у дома на ул. Кузнецова, 33. Этот «бедолага» сильно пострадал из-за строительства соседних кирпичных домов – у него треснул фундамент.\n\nДом начал проседать. Жить в нем стало опасно, жильцов расселили, а особняк законсервировали."}}
            }}
        };
    ...
    public static Stage CreateStage_MUR_5()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIQcmNXbyvEDETdoWf2-ZkWHzbykbwFAAIrvDEbhDnAStXp82q-HCWwAQADAgADeQADKgQ"}, Caption="Самолетики тоже относятся к маршруту «Спортивная история Томска: от ипподрома до Дворца спорта».\n\nБолее подробно историю, связанную с ГТО и спортом в СССР, ты можешь послушать <b> <a href=\"https://www.izi.travel/ru/c203-gorodskoy-marshrut-sportivnaya-istoriya-tomska-ot-ippodroma-do-dvorca-sporta/ru#b8e228ec-343d-494e-9b55-3ced80e6c1ac\">вот здесь</a></b>"}},
            }}
        };
        var step18 = new Step()
        {
        ...
        var stage = new Stage()
        {
            ...
            Location = new()
            {
                ...
                Address = "ул. Кузнецова, 26, Фтизиопульмонологический медцентр",
            }
        };
        var order = new List<StepInStage>()
        {
    ...
    public static Stage CreateStage_MUR_7()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIQfGNXdXMSmZgUek1ryPRawMkR66e0AAI1vDEbhDnASlKjbJXKLGHaAQADAgADeQADKgQ"}, Caption ="Ты задумывался о том, кто платит за красивые муралы на стенах? И как они вообще появляются в городе?\n\nТут есть несколько вариантов.\n\nНапример, художник может объявить о сборе денег и сделать нелегальную работу при помощи фанатов. А может участвовать в фестивалях или брать коммерческие заказы."}},
            }}
        };
    ...
    public static Stage CreateStage_MUR_8()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIQgmNXdjbFpU0YutaKMlLvJKdC5iOzAAI3vDEbhDnASvSAzOZ8X3TFAQADAgADeQADKgQ"}, Caption ="Еще одно место, которое захватили граффити-художники.\n\nВ 2021 году в течение суток здесь проходила нелегальная передвижная выставка «Сквозь дворы». Это кочующая по городам экспозиция и собрание творческих проектов. Как пишут ее организаторы, «Сквозь дворы» — это про свободу, про свободу во всем и для всех.\n\nМонстрика, которого ты видишь, рисовал Женя Борисов из LIMBO CREW – новосибирского тандема молодых художников."}},
            }}
        };
        var step24 = new Step()
        {
    ...
    public static Stage CreateStage_MUR_9()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Sound, Sound = new() {Type = SoundType.Voice, Voice=new(){FileId="AwACAgQAAxkBAAIQhmNXdwOgtZYBCIBY-h6W2TwV_j0GAAIGGwACitq4UpDxKNEtBHXzKgQ"}}, Caption ="Мне немного жаль, что в городе стало меньше озорства.\n\nВозможно, скоро новый уличный художник начнет заселять город своими персонажами."}},
            }}
        };
        ...
        var stage = new Stage()
        {
            ...
            Location = new()
            {
                ...
                Longitude = 84.949776,
                Label = "«Чертик»",
                Address = "месте между пр. Ленина, 48 и 50",
            }
        };
        var order = new List<StepInStage>()
        {
    ...
    public static Stage CreateStage_MUR_9_1()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIRqmNXy1mLLD1Q-4uc7CtlRweAPF2XAAJBvDEbhDnASkwFdggCPqn9AQADAgADeQADKgQ"}, Caption ="Ты еще не проголодался? Повезло, что прямо по нашему маршруту – <b>Make Love Pizza</b> на проспекте Ленина, 85а."}},
            }}
        };
        var step2 = new Step()
        {
            Fragments = new() { new() { Type = FragmentType.Text, Text = "Это очень уютная пиццерия, главный девиз которой: «Кайф! Драйв! Рок-н-ролл!».\n\nЗабежим к ним на пиццу или просто выпьем кофе под виниловые пластинки?",
            }}
        };
        var stage = new Stage()
        {
    ...
    public static Stage CreateStage_MUR_10()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIRrGNXy4p-VwABOjAexxhm4ikcXKR4MAACHr4xG3hswEqnRgyPQhOmuAEAAwIAA3kAAyoE"}, Caption ="Обрати внимание на дизайн интерьера – какие картины нарисованы на стенах!\n\nИ, кстати, в подвальчике Make Love Pizza проводят вечеринки, концерты и разные другие тусы. В общем, скучно тебе точно не будет.\n\nЕсли решишь забежать к моим друзьям, то они угостят тебя чашечкой фильтра при любом твоем заказе! <b>Промокод?</b>"}},
            }}
        };
        var stage = new Stage()
        {
    ...
    public static Stage CreateStage_MUR_11()
    {
        ...
        var stage = new Stage()
        {
            ...
            Location = new()
            {
                ...
                Address = "месте, рядом с Make Love Pizza",
            }
        };
        var order = new List<StepInStage>()
        {
    ...
    public static Stage CreateStage_MUR_12()
    {
        ...
        var step2 = new Step()
        {
            Fragments = new() { new() { Type = FragmentType.Text, Text = "Ты видишь муралы, которые создал художник Роман Ткачев. Они отражают дух свободы не только конца 1960-х годов, но и современной молодежи.\n\nС фестиваля «Вудсток», группы «Битлз» и Джимми Хендрикса когда-то начинался новый мир! В общем, make love, слушай крутую музыку и ешь вкусную пиццу.",
            }}
        };
        var step3 = new Step()
        {
    ...
    public static Stage CreateStage_MUR_13()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIQ6GNXik1x7lgDI-t9lP-Wq3V6G0gPAAKGvDEbhDnASv96w6MthceuAQADAgADeQADKgQ"}, Caption ="В 2021 году активисты общественной организации «Центр сохранения исторического наследия» Светлана Савина и Ольга Павлова придумали проект «Вдохни жизнь в томские окна».\n\nНазвание говорит само за себя – смотреть на заколоченные окна законсервированных домов очень печально, хотелось хотя бы с помощью картинок вдохнуть в них жизнь! И привлечь внимание к проблеме сохранения деревянных домов в Томске.\n\nТы видишь перед собой первый объект проекта – двухэтажный дом на улице Гагарина, 33. В его окнах: трогательные сцены из повседневной жизни, такие уютные, словно из детства. Эскизы разработали дизайнер Павел Богданов и художница Анна Турченко, а нарисовали волонтеры проекта. "}},
            }}
        };
        var step1 = new Step()
        {
    ...
    public static Stage CreateStage_MUR_14()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIQ7GNXjCb-zW-T4XnZRde8vjKZnDoLAAKNvDEbhDnASo2yE8P6wvymAQADAgADeQADKgQ"}, Caption ="Перед тобой еще один вариант – в 2021 году Владимир Абих во время фестиваля «мУкА. Склады искусства» создал не только масштабную работу на стене «научки» ТГУ, но и выполнил собственную культурную интервенцию. У Владимира есть проект «Субтитры».\n\nОн рисует на заброшенных объектах – домах, стадионах, концертных площадках. В Томске частью проекта стал давно заброшенный деревянный дом на улице Советской, 19. На нем появилась надпись «Пошел по наклонной»."}},
            }}
        };
    ...
    public static Stage CreateStage_MUR_15()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Sound, Sound = new() {Type = SoundType.Voice, Voice=new(){FileId="AwACAgQAAxkBAAIQ8mNXjmefnG3T18VkSXiLbxtCoEqdAAIaDQACitrAUn6OI-T7wpscKgQ"}}, Caption ="Мы с тобой уже немного узнали про тэги. Если забыл, напомню: это такая подпись граффити-художника, его никнейм.\n\nОбычно тэги делаются быстро, практически на ходу, маркером или баллоном. Но не все так просто!"}},
            }}
        };
        var step2 = new Step()
        {
    ...
    public static Stage CreateStage_MUR_17()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIQ-mNXkXJQNEI_V-2ZuqwlN-Mf7nP2AAKavDEbhDnASgABHA0zPFw0EwEAAwIAA3kAAyoE"}, Caption ="В 2022 году фестиваль «мУкА. Склады искусства» проходил на территории пустующего кинотеатра «Киномир» в самом центре Томска.\n\nНынешний владелец здания планирует сделать в нем центр современного искусства. Исполнится ли этот проект, сказать пока что сложно, но память и впечатления от фестиваля точно сохранятся! "}},
            }}
        };
        var step2 = new Step()
        {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIQ_mNXkkh8aegC8_w5n_lReIySvUrOAAKivDEbhDnASq3-6uZtgPuKAQADAgADeQADKgQ"}, Caption ="Дальше ты видишь работу художника из Нижнего Новгорода Никиты Nomerz’а «Это не кино»."}},
            }}
        };
        ...
        var stage = new Stage()
        {
            ...
            Location = new()
            {
                ...
                Address = "ул. Нахановича, 7 / пр. Ленина, 101",
            }
        };
        var order = new List<StepInStage>()
        {
    ...
    public static Stage CreateStage_MUR_19()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIRCmNXnUrjKSTNhNmOjBMs_HFWsxnDAAItvTEbeGzAShAoeCV_mLhhAQADAgADeQADKgQ"}, Caption ="Перед тобой баннеры с персонажами питерского художника и дизайнера Андрея Люблинского.\n\nОн создал около 350 персонажей, часть из них – герои собственной мифологии художника, часть – оригинальные версии культовых фигур из истории и различных сфер современной культуры.\n\nВы найдете в его коллекции кого угодно – от политиков и героев мультфильмов, до религиозных деятелей и домашних животных."}},
            }}
        };
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIRDmNXndhHYx8cMSI9WpikbZzPA-5kAAIzvTEbeGzASv9wZfOXbkjGAQADAgADeQADKgQ"}, Caption ="А сейчас мы с тобой пойдем во внутренний двор кинотеатра. Ты был тут когда-нибудь?\n\nМежду прочим, это культовое для томских райтеров место! Уже больше 20 лет двор захвачен граффитосами.\n\nНо первое, что мы увидим, свернув во двор, это свежая работа с фестиваля «мУкА»."}},
            }}
        };
    ...
    public static Stage CreateStage_MUR_20()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Text, Text = "О своей работе они пишут так:\n\n«Отсылка к кинотеатру и к самим художницам лично. Это про то, как кинотеатр возвращается, но в другом обличии (как и Терминатор возвращается в женском), и это про нас»",
            }}
        };
        var step46 = new Step()
        {
        ...
        var stage = new Stage()
        {
            ...
            Location = new()
            {
                ...
                Address = "пр. Ленина, 101, внутренний двор",
            }
        };
        var order = new List<StepInStage>()
        {
    ...
    public static Stage CreateStage_MUR_21()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIRFGNXn2CCSZoIOx6wD69yd6jSLwfNAAJAvTEbeGzASrgkSxbwtbbrAQADAgADeQADKgQ"}, Caption ="Вот ты в одном из самых старых спотов Томска. Сменяются поколения граффити-художников, а место остается.\n\nПредставляешь, сколько на этих стенах наслоений тэгов и рисунков?"}},
            }}
        };
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIRGGNXn9HWZ3v7vFn7zOC4ore2BLDBAAJBvTEbeGzASgv_tfTzv2cTAQADAgADeQADKgQ"}, Caption ="Давай заглянем в еще одну арку – там ты увидишь уже немного облупившиеся и «завандаленные» работы 2017 года, которые делали художники из России и Германии.\n\nКак же они оказались в одном месте?"}},
            }}
        };
    ...
    public static Stage CreateStage_MUR_22()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIRHmNXoVxRK003II63MPR80twDLeLRAAJLvTEbeGzASpWWKaoVMBb9AQADAgADeQADKgQ"}, Caption ="Сейчас мы с тобой перейдем дорогу и отравимся в еще одно место, культовое для граффити-художников Томска.\n\nДо 2019 года там в основном были текстовые граффити – каждый мог оставить свое высказывание. Иногда диалоги и целые поэмы занимали все стены. Все это есть и так. Но с 2019 года там появились и большие муралы."}},
            }}
        };
        ...
        var stage = new Stage()
        {
            ...
            Location = new()
            {
                ...
                Address = "пр. Ленина, 97а, внутренний двор",
            }
        };
        var order = new List<StepInStage>()
        {
    ...
    public static Stage CreateStage_MUR_23()
    {
        ...
        var stage = new Stage()
        {
            ...
            Location = new()
            {
                ...
                Address = "пр. Ленина, 78/1, внутренний двор",
            }
        };
        var order = new List<StepInStage>()
        {
    ...
    public static Stage CreateStage_MUR_24()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIRKGNXo6zw1cErFUauXgHiOvCsM2DgAAJjvTEbeGzAStrkyfr7IPLUAQADAgADeQADKgQ"}, Caption = "Еще один двор в самом центре Томска.\n\nИ снова результаты большой граффити-тусы. Художники, приехавшие на фестиваль Street Vision в 2021 году, просто решили немного кайфануть от совместной работы в каком-то знаковом месте.\n\nНа фестивале каждый делал свой проект, а все вместе они захватили пространство у бара Dealers.\n\nЭта территория уже много лет была спотом, но не таким масштабным. В 2021-м здесь оставили свои работы граффити-художники под никами Enor, Rasko, Rebel, Brusto, Mack, Chervi, Jovanny, Eknot, Uut4k, Dzhio. "}},
            }}
        };
        ...
        var stage = new Stage()
        {
            ...
            Location = new()
            {
                ...
                Longitude = 84.949517,
                Label = "Спорт «Dealers»",
                Address = "пр. Ленина, 111, внутренний двор",
            }
        };
        var order = new List<StepInStage>()
        {
    ...
    public static Stage CreateStage_MUR_25_1()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIRKmNXpH_FWfmpa6tKP6VwuCUQ0I6UAAJvvTEbeGzASttIy6-yM1V0AQADAgADeQADKgQ"}, Caption = "Мы с тобой прошли уже большую часть маршрута.\n\nИ, как это обычно бывает, самое сладенькое у нас еще впереди! Но, если ты такой же сладкоежка и любитель кофе, как и я, то нам надо сделать небольшой перерыв. И зайти в кондитерскую TORTA на Набережной реки Ушайки, 16"}},
            }}
        };
    ...
    public static Stage CreateStage_MUR_25_2()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIRLGNXpQynvOFViC_ltjx3k50Di40IAAJyvTEbeGzASmC24DhTHyAIAQADAgADeQADKgQ"}, Caption = "Всего в Томске четыре таких кондитерских, но в этой особый акцент сделан на историю Томска. здесь и карта города, и эксклюзивные открытки, и даже фирменный торт «Томск»!\n\nИнтересно, почему до сих пор не придумали торт «Студенческий»?"}},
            }}
        };
        var step55_2 = new Step()
        {
            Fragments = new() { new() { Type = FragmentType.Text, Text = "Помимо десертов, у Tortы есть свои завтраки в кондитерской на проспекте Фрунзе, 98. Пышные панкейки, сэндвичи и многое другое.\n\nА специально для тебя Торта дарит скидку 30 % на все кофейные напитки по промокоду «Ефим» – так меня зовут, надеюсь, не забыл? Давай зайдем и попробуем?",
            }}
        };
    ...
    public static Stage CreateStage_MUR_25_3()
    {
        ...
        var stage = new Stage()
        {
            ...
            Location = new()
            {
                ...
                Longitude = 84.950418,
                Label = "Торта",
                Address = "ул. Набережная реки Ушайки, 16",
            }
        };
        var order = new List<StepInStage>()
        {
    ...
    public static Stage CreateStage_MUR_26()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIRMGNXqGT1K_Ppri74LBPddy5yqeKsAAKFvTEbeGzASjma_0h0mf8uAQADAgADeQADKgQ"}, Caption = "Как ты относишься к голубям? А к большим нарисованным голубям, которые что-то знают?\n\nВ 2015 году в Томске вместо полноценного фестиваля Street Vision прошла рейв-тусовка.\n\nПо воспоминаниям участников, тогда у художников остались баллоны, и они решили сделать большой мурал. Так и появился голубь на здании по ул. Набережная реки Ушайки, 8а."}},
            }}
        };
        var step58 = new Step()
        {
    ...
    public static Stage CreateStage_MUR_27()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIRNGNXqgLorAaPD3agYspW1i0_lEWIAAKJvTEbeGzASur6Ue5SqDM8AQADAgADeQADKgQ"}, Caption = "Знаешь, меня всегда радует, когда уличный художник чувствует место и встраивает свою работу так, что пространство становится частью произведения.\n\nЯ так и не нашел, кто автор данной работы. Но видно, что ее делал мастер! Он не спорит со стеной, не хочет ее подчинить, он просто оставил на ней свое лирическое высказывание.\n\nО чем оно, ты можешь придумать сам – об одиночестве, поиске света или чем-то другом… Я не знаю, но мне просто нравится, что где-то в Томске мне светит такой фонарь."}},
            }}
        };
        var step60 = new Step()
        {
        ...
        var stage = new Stage()
        {
            ...
            Location = new()
            {
                ...
                Longitude = 84.951909,
                Label = "Фонарь",
                Address = "ул. Набережная реки ушайки, 6/2",
            }
        };
        var order = new List<StepInStage>()
        {
    ...
    public static Stage CreateStage_MUR_28()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIROGNXqxi50MFFkemwJOlSrr2maVVfAAKLvTEbeGzASuyp-mfd2CJ4AQADAgADeQADKgQ"}, Caption = "Здесь перед тобой история про великого просветителя земли сибирской Петра Макушина. Причем тут бомба?\n\nО, это была душещипательная история о том, как на книгоиздателя Макушина написали донос. Мол, он хочет взорвать цесаревича Николая, будущего царя Николая второго! Как развивалась и чем закончилась эта история, ты сможешь узнать вот <b> <a href=\"https://www.izi.travel/ru/98b8-gorodskoy-marshrut-po-sledam-petra-makushina/ru\">в этом аудиогиде</a> </b>"}},
            }}
        };
        var step62 = new Step()
        {
        ...
        var stage = new Stage()
        {
            ...
            Location = new()
            {
                ...
                Address = "ул. Небережная реки Ушайки, 4",
            }
        };
        var order = new List<StepInStage>()
        {
    ...
    public static Stage CreateStage_MUR_29()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIRPGNXq9V0KLOBbVuqTqgWArA7YuhWAAKNvTEbeGzASgpLDAXNkZcRAQADAgADeQADKgQ"}, Caption ="В прошлом, 2021 году, фестиваль впервые вышел с масштабными работами в исторический центр, да еще и в знаковых точках!\n\nПроект по созданию больших арт-объектов в центре Томска так и назвали – «Выход в город»."}},
            }}
        };
    ...
    public static Stage CreateStage_MUR_30()
    {
        ...
        {
            Fragments = new() { new() { Type = FragmentType.Media,
            Media = new() {new(){Type=MediaType.Photo, Photo = new(){FileId="AgACAgIAAxkBAAIRaWNXsDBIcFFureloT3iOQgp8SLj0AAKrvTEbeGzASo5XJHkgpSjHAQADAgADeQADKgQ"}, Caption ="Еще одна работа – воспоминание о «Выходе в город».\n\nТы удивишься, но она выполнена вообще без краски! Художники обыграли тему кондиционеров и жестяных труб водостоков и использовали штукатурку. Выложив такой рисунок, они хотели примирить коммуникации и декор. Сделать так, чтобы они «вступили друг с другом в диалог».\n\nЧтобы у того, кто смотрит на «Рельеф №3», объемные формы работы дарили ощущение, что «солнце разгонит тучи, звезда не успеет упасть до того, как ты загадаешь желание»."}},
            }}
        };
        var step66 = new Step()
        {
        ...
        var stage = new Stage()
        {
            ...
            Location = new()
            {
                ...
                Longitude = 84.950014,
                Label = "Рельеф №3",
                Address = "ул. Розы Люксембург, 6/1, внутренний двор",
            }
        };
        var order = new List<StepInStage>()
        {
    ...
    public static Stage CreateStage_MUR_32()
    {
        var step68 = new Step()
        {
            Fragments = new() { new() { Type = FragmentType.Text, Text = "Вот и завершилась наша с тобой прогулка. Конечно, это только малая часть уличного искусства в Томске.\n\nНадеюсь, тебе было интересно, и ты теперь будешь больше внимания обращать на стены и тротуар, не лениться заходить во дворы и арки. И город будет открываться перед тобой все больше и больше.",
            }}
        };
        var step69 = new Step()
        {
        ...
        var order = new List<StepInStage>()
        {
            new() {AttachedStage = stage, Payload = step68, Order = 1, Delay = 0 },
            new() {AttachedStage = stage, Payload = step69, Order = 2, Delay = 0 },
        };
        stage.Steps = order;
        return stage;
    }
